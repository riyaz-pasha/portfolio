    ...
    return (
        <AnimatePresence mode="wait">
            ...
            >
                {navItems.map((navItem: NavItem, idx: number) => (
                    <Link
                        ...
                        className={cn(
                            ...
                            "space-x-1",
                            "text-secondaryText hover:font-semibold",
                            " hover:text-current",
                        )}
                    >
                ...
                <button className={cn(
                    "border bg-secondaryBackground rounded-full relative",
                    "text-sm font-medium px-4 py-2",
                )}>
                    <span>Login</span>
                    <span className={cn(
                        "absolute inset-x-0 w-1/2 mx-auto -bottom-px",
                        "bg-gradient-to-r from-transparent via-primary to-transparent h-px",
                    )} />
                </button>
            </motion.div>
        </AnimatePresence>
